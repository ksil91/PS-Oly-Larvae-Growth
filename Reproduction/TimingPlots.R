...
png(filename = "stacked_larvae_timing_PS2015_bw_percap.png")
grid.arrange(b3,l_bw,nrow=2)
dev.off()
...
png(filename = "stacked_larvae_timing_PS2015_color_percap.png")
grid.newpage()
grid.draw(rbind(ggplotGrob(b),ggplotGrob(l),size="last"))
dev.off()
...
bl
#png(filename = "overlay_larvae_timing_PS2015_color_percap.png")
